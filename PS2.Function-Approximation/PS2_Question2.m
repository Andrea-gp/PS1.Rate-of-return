...
syms x y X Y
f=((1-alpha)*x.^((sigma-1)/sigma)+alpha*y.^((sigma-1)/sigma)).^(sigma/(sigma-1));
cheb_graph11=subs(cheb_approx_11,{x,y},{X,Y})
cheb_graph3=subs(cheb_approx_3,{x,y},{X,Y})
cheb_graph15=subs(cheb_approx_15,{x,y},{X,Y})
x=0:0.1:10
y=0:0.1:10
[X Y]=meshgrid(x, y)
Z=((1-alpha).*X.^((sigma-1)/sigma)+alpha.*Y.^((sigma-1)/sigma)).^(sigma/(sigma-1));
Z1=(6074581676293659221280378955158765.*(X./5 - 1).*(X./5 - 2.*(X./5 - 1)*(2*(X./5 - 1).^2 - 1)+ 2.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).^2 - 1) - X./5 + 1) - 2.*(X./5 - 1).^2 + 1) - 1))./789746323942186917132446096949248 - (6074581676293659221280378955158765.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).*(X./5 - 2.*(X./5 - 1).*(2.*(X./5 - 1).^2 - 1)+ 2.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).^2 - 1) - X./5 + 1) - 2.*(X./5 - 1).^2 + 1) - 1)- 2.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).^2 - 1) - X./5 + 1) + 2.*(X./5 - 1).^2 - 1) - X./5 + 2.*(X./5 - 1).*(2.*(X./5 - 1).^2 - 1)- 2.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).^2 - 1) - X./5 + 1) - 2.*(X./5 - 1).^2 + 1) + 1))./789746323942186917132446096949248 - (6074581676293659221280378955158765.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).^2 - 1) - X./5 + 1))./789746323942186917132446096949248 + (6074581676293659221280378955158765.*(X./5 - 1).*(X./5 - 2.*(X./5 - 1).*(2.*(X./5 - 1).*(X./5 - 2.*(X./5 - 1).*(2.*(X./5 - 1).^2 - 1) + 2.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).^2 - 1) - X./5 + 1) - 2.*(X./5 - 1).^2 + 1) - 1) - 2.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).^2 - 1) - X./5 + 1) + 2.*(X./5 - 1).^2 - 1) + 2.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).*(X./5 - 2.*(X./5 - 1).*(2.*(X./5 - 1).^2 - 1) + 2.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).^2 - 1) - X./5 + 1) - 2.*(X./5 - 1).^2 + 1) - 1) - 2.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).^2 - 1) - X./5 + 1) + 2.*(X./5 - 1).^2 - 1) - X./5 + 2.*(X./5 - 1).*(2.*(X./5 - 1).^2 - 1) - 2.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).^2 - 1) - X./5 + 1) - 2.*(X./5 - 1).^2 + 1) + 1) - 2.*(X./5 - 1).*(X./5 - 2.*(X./5 - 1).*(2.*(X./5 - 1).^2 - 1)+ 2.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).^2 - 1) - X./5 + 1) - 2.*(X./5 - 1).^2 + 1) - 1) + 2.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).^2 - 1) - X./5 + 1)- 2.*(X./5 - 1).^2 + 1) - 2.*(X./5 - 1).*(2.*(X./5 - 1).^2 - 1) + 2.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).*(2.*(X./5 - 1).^2 - 1) - X./5 + 1) - 2.*(X./5 - 1).^2 + 1) - 1))./789746323942186917132446096949248 + (6074581676293659221280378955158765.*(X./5 - 1).^2)./789746323942186917132446096949248 - 6074581676293659221280378955158765/1579492647884373834264892193898496
Z2=10.*(X./5 - 1).^2 - 5
surf(X, Y, Z)
hold on
surf(X, Y, Z1)
title('CES function vs Chebyshev polynomial order 11')
surf(X, Y, Z)
hold on
surf(X, Y, Z2)
title('CES function vs Chebyshev polynomial order 3')
